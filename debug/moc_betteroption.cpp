...
QT_MOC_LITERAL(5, 52, 13) // "clearUserFile"

    },
    "betterOption\0isOpenChanged\0\0CountMaxed\0"
    "colorChanged\0clearUserFile"
};
...
void betterOption::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->colorChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (betterOption::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&betterOption::colorChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void betterOption::colorChanged(int _t1)
{
